...
type MetadataInproxy struct {
	...
	InproxyWebrtcDnsPreferred                        *string                `protobuf:"bytes,69,opt,name=inproxy_webrtc_dns_preferred,json=inproxyWebrtcDnsPreferred,proto3,oneof" json:"inproxy_webrtc_dns_preferred,omitempty"`       //LowCardinality
	InproxyWebrtcDnsPreresolved                      *string                `protobuf:"bytes,70,opt,name=inproxy_webrtc_dns_preresolved,json=inproxyWebrtcDnsPreresolved,proto3,oneof" json:"inproxy_webrtc_dns_preresolved,omitempty"` //LowCardinality
	...
	InproxyWebrtcDnsTransform                        *string                `protobuf:"bytes,74,opt,name=inproxy_webrtc_dns_transform,json=inproxyWebrtcDnsTransform,proto3,oneof" json:"inproxy_webrtc_dns_transform,omitempty"` //LowCardinality
	...
	InproxyWebrtcLocalIceCandidateType               *string                `protobuf:"bytes,78,opt,name=inproxy_webrtc_local_ice_candidate_type,json=inproxyWebrtcLocalIceCandidateType,proto3,oneof" json:"inproxy_webrtc_local_ice_candidate_type,omitempty"` //LowCardinality
	...
	InproxyWebrtcRemoteIceCandidateType              *string                `protobuf:"bytes,84,opt,name=inproxy_webrtc_remote_ice_candidate_type,json=inproxyWebrtcRemoteIceCandidateType,proto3,oneof" json:"inproxy_webrtc_remote_ice_candidate_type,omitempty"`                                         //LowCardinality
	InproxyWebrtcStunServer                          *string                `protobuf:"bytes,85,opt,name=inproxy_webrtc_stun_server,json=inproxyWebrtcStunServer,proto3,oneof" json:"inproxy_webrtc_stun_server,omitempty"`                                                                                 //LowCardinality
	InproxyWebrtcStunServer_RFC5780                  *string                `protobuf:"bytes,86,opt,name=inproxy_webrtc_stun_server_RFC5780,json=inproxyWebrtcStunServerRFC5780,proto3,oneof" json:"inproxy_webrtc_stun_server_RFC5780,omitempty"`                                                          //LowCardinality
	InproxyWebrtcStunServer_RFC5780ResolvedIpAddress *string                `protobuf:"bytes,87,opt,name=inproxy_webrtc_stun_server_RFC5780_resolved_ip_address,json=inproxyWebrtcStunServerRFC5780ResolvedIpAddress,proto3,oneof" json:"inproxy_webrtc_stun_server_RFC5780_resolved_ip_address,omitempty"` //LowCardinality
	InproxyWebrtcStunServerResolvedIpAddress         *string                `protobuf:"bytes,88,opt,name=inproxy_webrtc_stun_server_resolved_ip_address,json=inproxyWebrtcStunServerResolvedIpAddress,proto3,oneof" json:"inproxy_webrtc_stun_server_resolved_ip_address,omitempty"`                        //LowCardinality
...
const file_proto_metadata_proto_rawDesc = "" +
	"\n" +
	"\x14proto/metadata.proto\x12\bpsiphond\x1a\x1fgoogle/protobuf/timestamp.proto\"\xbc\x04\n" +
	...
	" inproxy_proxy_stored_tactics_tag\x18A \x01(\tH>R\x1cinproxyProxyStoredTacticsTag\x88\x01\x01\x12W\n" +
	...
	"\x1ainproxy_webrtc_dns_attempt\x18D \x01(\x03HAR\x17inproxyWebrtcDnsAttempt\x88\x01\x01\x12D\n" +
	"\x1cinproxy_webrtc_dns_preferred\x18E \x01(\tHBR\x19inproxyWebrtcDnsPreferred\x88\x01\x01\x12H\n" +
	"\x1einproxy_webrtc_dns_preresolved\x18F \x01(\tHCR\x1binproxyWebrtcDnsPreresolved\x88\x01\x01\x12Q\n" +
	"#inproxy_webrtc_dns_qname_mismatches\x18G \x01(\x03HDR\x1finproxyWebrtcDnsQnameMismatches\x88\x01\x01\x12P\n" +
	"#inproxy_webrtc_dns_qname_must_match\x18H \x01(\bHER\x1einproxyWebrtcDnsQnameMustMatch\x88\x01\x01\x12V\n" +
	"&inproxy_webrtc_dns_qname_random_casing\x18I \x01(\bHFR!inproxyWebrtcDnsQnameRandomCasing\x88\x01\x01\x12D\n" +
	"\x1cinproxy_webrtc_dns_transform\x18J \x01(\tHGR\x19inproxyWebrtcDnsTransform\x88\x01\x01\x12]\n" +
	"*inproxy_webrtc_local_ice_candidate_is_IPv6\x18K \x01(\bHHR$inproxyWebrtcLocalIceCandidateIsIPv6\x88\x01\x01\x12g\n" +
	"/inproxy_webrtc_local_ice_candidate_is_initiator\x18L \x01(\bHIR)inproxyWebrtcLocalIceCandidateIsInitiator\x88\x01\x01\x12X\n" +
	"'inproxy_webrtc_local_ice_candidate_port\x18M \x01(\x03HJR\"inproxyWebrtcLocalIceCandidatePort\x88\x01\x01\x12X\n" +
	"'inproxy_webrtc_local_ice_candidate_type\x18N \x01(\tHKR\"inproxyWebrtcLocalIceCandidateType\x88\x01\x01\x12Y\n" +
	"'inproxy_webrtc_padded_messages_received\x18O \x01(\x03HLR#inproxyWebrtcPaddedMessagesReceived\x88\x01\x01\x12Q\n" +
	"#inproxy_webrtc_padded_messages_sent\x18P \x01(\x03HMR\x1finproxyWebrtcPaddedMessagesSent\x88\x01\x01\x12F\n" +
	"\x1dinproxy_webrtc_randomize_dtls\x18Q \x01(\bHNR\x1ainproxyWebrtcRandomizeDtls\x88\x01\x01\x12_\n" +
	"+inproxy_webrtc_remote_ice_candidate_is_IPv6\x18R \x01(\bHOR%inproxyWebrtcRemoteIceCandidateIsIPv6\x88\x01\x01\x12Z\n" +
	"(inproxy_webrtc_remote_ice_candidate_port\x18S \x01(\x03HPR#inproxyWebrtcRemoteIceCandidatePort\x88\x01\x01\x12Z\n" +
	"(inproxy_webrtc_remote_ice_candidate_type\x18T \x01(\tHQR#inproxyWebrtcRemoteIceCandidateType\x88\x01\x01\x12@\n" +
	"\x1ainproxy_webrtc_stun_server\x18U \x01(\tHRR\x17inproxyWebrtcStunServer\x88\x01\x01\x12O\n" +
	"\"inproxy_webrtc_stun_server_RFC5780\x18V \x01(\tHSR\x1einproxyWebrtcStunServerRFC5780\x88\x01\x01\x12t\n" +
	"6inproxy_webrtc_stun_server_RFC5780_resolved_ip_address\x18W \x01(\tHTR/inproxyWebrtcStunServerRFC5780ResolvedIpAddress\x88\x01\x01\x12e\n" +
	".inproxy_webrtc_stun_server_resolved_ip_address\x18X \x01(\tHUR(inproxyWebrtcStunServerResolvedIpAddress\x88\x01\x01\x12K\n" +
	" inproxy_webrtc_use_media_streams\x18Y \x01(\bHVR\x1cinproxyWebrtcUseMediaStreams\x88\x01\x01B\x1c\n" +
	...
	" meek_underlying_connection_count\x18\x10 \x01(\x03H\x0fR\x1dmeekUnderlyingConnectionCount\x88\x01\x01B%\n" +
	...
	"!_meek_underlying_connection_count\"\xaf\x04\n" +
	"\fMetadataQuic\x12+\n" +
	...
	"\x13_shadowsocks_prefixB?Z=github.com/Psiphon-Labs/psiphon-tunnel-core/psiphon/server/pbb\x06proto3"
...
func file_proto_metadata_proto_init() {
	...
	file_proto_metadata_proto_msgTypes[0].OneofWrappers = []any{}
	file_proto_metadata_proto_msgTypes[1].OneofWrappers = []any{}
	file_proto_metadata_proto_msgTypes[2].OneofWrappers = []any{}
	file_proto_metadata_proto_msgTypes[3].OneofWrappers = []any{}
	file_proto_metadata_proto_msgTypes[4].OneofWrappers = []any{}
	file_proto_metadata_proto_msgTypes[5].OneofWrappers = []any{}
	file_proto_metadata_proto_msgTypes[6].OneofWrappers = []any{}
	file_proto_metadata_proto_msgTypes[7].OneofWrappers = []any{}
	file_proto_metadata_proto_msgTypes[8].OneofWrappers = []any{}
	file_proto_metadata_proto_msgTypes[9].OneofWrappers = []any{}
	type x struct{}
