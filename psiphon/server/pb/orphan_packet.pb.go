...
const file_proto_orphan_packet_proto_rawDesc = "" +
	"\n" +
	"\x19proto/orphan_packet.proto\x12\bpsiphond\"\x8a#\n" +
	"\fOrphanPacket\x12c\n" +
	...
	"$_upstream_packet_rejected_no_sessionB?Z=github.com/Psiphon-Labs/psiphon-tunnel-core/psiphon/server/pbb\x06proto3"
...
func file_proto_orphan_packet_proto_init() {
	...
	file_proto_orphan_packet_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
