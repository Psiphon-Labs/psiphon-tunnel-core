...
type ServerLoadProtocol struct {
	...
	AcceptedClients    *int64                 `protobuf:"varint,103,opt,name=accepted_clients,json=acceptedClients,proto3,oneof" json:"accepted_clients,omitempty"`
	EstablishedClients *int64                 `protobuf:"varint,104,opt,name=established_clients,json=establishedClients,proto3,oneof" json:"established_clients,omitempty"`
...
type ServerLoad struct {
	...
	ServerTacticsCacheMissCount             *int64                 `protobuf:"varint,123,opt,name=server_tactics_cache_miss_count,json=serverTacticsCacheMissCount,proto3,oneof" json:"server_tactics_cache_miss_count,omitempty"`
	ServerTacticsMaxCacheEntries            *int64                 `protobuf:"varint,124,opt,name=server_tactics_max_cache_entries,json=serverTacticsMaxCacheEntries,proto3,oneof" json:"server_tactics_max_cache_entries,omitempty"`
	ServerTacticsMaxParameterReferences     *int64                 `protobuf:"varint,125,opt,name=server_tactics_max_parameter_references,json=serverTacticsMaxParameterReferences,proto3,oneof" json:"server_tactics_max_parameter_references,omitempty"`
	DialingTcpPortForwards                  *int64                 `protobuf:"varint,126,opt,name=dialing_tcp_port_forwards,json=dialingTcpPortForwards,proto3,oneof" json:"dialing_tcp_port_forwards,omitempty"`
	TcpIpv4PortForwardDialedCount           *int64                 `protobuf:"varint,127,opt,name=tcp_ipv4_port_forward_dialed_count,json=tcpIpv4PortForwardDialedCount,proto3,oneof" json:"tcp_ipv4_port_forward_dialed_count,omitempty"`
	TcpIpv4PortForwardDialedDuration        *int64                 `protobuf:"varint,128,opt,name=tcp_ipv4_port_forward_dialed_duration,json=tcpIpv4PortForwardDialedDuration,proto3,oneof" json:"tcp_ipv4_port_forward_dialed_duration,omitempty"`
	TcpIpv4PortForwardFailedCount           *int64                 `protobuf:"varint,129,opt,name=tcp_ipv4_port_forward_failed_count,json=tcpIpv4PortForwardFailedCount,proto3,oneof" json:"tcp_ipv4_port_forward_failed_count,omitempty"`
	TcpIpv4PortForwardFailedDuration        *int64                 `protobuf:"varint,130,opt,name=tcp_ipv4_port_forward_failed_duration,json=tcpIpv4PortForwardFailedDuration,proto3,oneof" json:"tcp_ipv4_port_forward_failed_duration,omitempty"`
	TcpIpv6PortForwardDialedCount           *int64                 `protobuf:"varint,131,opt,name=tcp_ipv6_port_forward_dialed_count,json=tcpIpv6PortForwardDialedCount,proto3,oneof" json:"tcp_ipv6_port_forward_dialed_count,omitempty"`
	TcpIpv6PortForwardDialedDuration        *int64                 `protobuf:"varint,132,opt,name=tcp_ipv6_port_forward_dialed_duration,json=tcpIpv6PortForwardDialedDuration,proto3,oneof" json:"tcp_ipv6_port_forward_dialed_duration,omitempty"`
	TcpIpv6PortForwardFailedCount           *int64                 `protobuf:"varint,133,opt,name=tcp_ipv6_port_forward_failed_count,json=tcpIpv6PortForwardFailedCount,proto3,oneof" json:"tcp_ipv6_port_forward_failed_count,omitempty"`
	TcpIpv6PortForwardFailedDuration        *int64                 `protobuf:"varint,134,opt,name=tcp_ipv6_port_forward_failed_duration,json=tcpIpv6PortForwardFailedDuration,proto3,oneof" json:"tcp_ipv6_port_forward_failed_duration,omitempty"`
	TcpPortForwardDialedCount               *int64                 `protobuf:"varint,135,opt,name=tcp_port_forward_dialed_count,json=tcpPortForwardDialedCount,proto3,oneof" json:"tcp_port_forward_dialed_count,omitempty"`
	TcpPortForwardDialedDuration            *int64                 `protobuf:"varint,136,opt,name=tcp_port_forward_dialed_duration,json=tcpPortForwardDialedDuration,proto3,oneof" json:"tcp_port_forward_dialed_duration,omitempty"`
	TcpPortForwardFailedCount               *int64                 `protobuf:"varint,137,opt,name=tcp_port_forward_failed_count,json=tcpPortForwardFailedCount,proto3,oneof" json:"tcp_port_forward_failed_count,omitempty"`
	TcpPortForwardFailedDuration            *int64                 `protobuf:"varint,138,opt,name=tcp_port_forward_failed_duration,json=tcpPortForwardFailedDuration,proto3,oneof" json:"tcp_port_forward_failed_duration,omitempty"`
	TcpPortForwardRejectedDialingLimitCount *int64                 `protobuf:"varint,139,opt,name=tcp_port_forward_rejected_dialing_limit_count,json=tcpPortForwardRejectedDialingLimitCount,proto3,oneof" json:"tcp_port_forward_rejected_dialing_limit_count,omitempty"`
	TcpPortForwardRejectedDisallowedCount   *int64                 `protobuf:"varint,140,opt,name=tcp_port_forward_rejected_disallowed_count,json=tcpPortForwardRejectedDisallowedCount,proto3,oneof" json:"tcp_port_forward_rejected_disallowed_count,omitempty"`
	TcpPortForwards                         *int64                 `protobuf:"varint,141,opt,name=tcp_port_forwards,json=tcpPortForwards,proto3,oneof" json:"tcp_port_forwards,omitempty"`
	UdpPortForwardRejectedDisallowedCount   *int64                 `protobuf:"varint,142,opt,name=udp_port_forward_rejected_disallowed_count,json=udpPortForwardRejectedDisallowedCount,proto3,oneof" json:"udp_port_forward_rejected_disallowed_count,omitempty"`
	UdpPortForwards                         *int64                 `protobuf:"varint,143,opt,name=udp_port_forwards,json=udpPortForwards,proto3,oneof" json:"udp_port_forwards,omitempty"`
	TotalTcpPortForwards                    *int64                 `protobuf:"varint,144,opt,name=total_tcp_port_forwards,json=totalTcpPortForwards,proto3,oneof" json:"total_tcp_port_forwards,omitempty"`
	TotalUdpPortForwards                    *int64                 `protobuf:"varint,145,opt,name=total_udp_port_forwards,json=totalUdpPortForwards,proto3,oneof" json:"total_udp_port_forwards,omitempty"`
	unknownFields                           protoimpl.UnknownFields
	sizeCache                               protoimpl.SizeCache
}
...
const file_proto_server_load_proto_rawDesc = "" +
	"\n" +
	"\x17proto/server_load.proto\x12\bpsiphond\x1a\x1fgoogle/protobuf/timestamp.proto\"\xfd\x01\n" +
	...
	"\x10accepted_clients\x18g \x01(\x03H\x02R\x0facceptedClients\x88\x01\x01\x124\n" +
	"\x13established_clients\x18h \x01(\x03H\x03R\x12establishedClients\x88\x01\x01B\t\n" +
	"\a_regionB\v\n" +
	"\t_protocolB\x13\n" +
	...
	"\x1fserver_tactics_cache_miss_count\x18{ \x01(\x03H\x16R\x1bserverTacticsCacheMissCount\x88\x01\x01\x12K\n" +
	...
	"\"tcp_ipv4_port_forward_dialed_count\x18\x7f \x01(\x03H\x1aR\x1dtcpIpv4PortForwardDialedCount\x88\x01\x01\x12U\n" +
	"%tcp_ipv4_port_forward_dialed_duration\x18\x80\x01 \x01(\x03H\x1bR tcpIpv4PortForwardDialedDuration\x88\x01\x01\x12O\n" +
	"\"tcp_ipv4_port_forward_failed_count\x18\x81\x01 \x01(\x03H\x1cR\x1dtcpIpv4PortForwardFailedCount\x88\x01\x01\x12U\n" +
	"%tcp_ipv4_port_forward_failed_duration\x18\x82\x01 \x01(\x03H\x1dR tcpIpv4PortForwardFailedDuration\x88\x01\x01\x12O\n" +
	"\"tcp_ipv6_port_forward_dialed_count\x18\x83\x01 \x01(\x03H\x1eR\x1dtcpIpv6PortForwardDialedCount\x88\x01\x01\x12U\n" +
	"%tcp_ipv6_port_forward_dialed_duration\x18\x84\x01 \x01(\x03H\x1fR tcpIpv6PortForwardDialedDuration\x88\x01\x01\x12O\n" +
	"\"tcp_ipv6_port_forward_failed_count\x18\x85\x01 \x01(\x03H R\x1dtcpIpv6PortForwardFailedCount\x88\x01\x01\x12U\n" +
	"%tcp_ipv6_port_forward_failed_duration\x18\x86\x01 \x01(\x03H!R tcpIpv6PortForwardFailedDuration\x88\x01\x01\x12F\n" +
	"\x1dtcp_port_forward_dialed_count\x18\x87\x01 \x01(\x03H\"R\x19tcpPortForwardDialedCount\x88\x01\x01\x12L\n" +
	" tcp_port_forward_dialed_duration\x18\x88\x01 \x01(\x03H#R\x1ctcpPortForwardDialedDuration\x88\x01\x01\x12F\n" +
	"\x1dtcp_port_forward_failed_count\x18\x89\x01 \x01(\x03H$R\x19tcpPortForwardFailedCount\x88\x01\x01\x12L\n" +
	" tcp_port_forward_failed_duration\x18\x8a\x01 \x01(\x03H%R\x1ctcpPortForwardFailedDuration\x88\x01\x01\x12d\n" +
	"-tcp_port_forward_rejected_dialing_limit_count\x18\x8b\x01 \x01(\x03H&R'tcpPortForwardRejectedDialingLimitCount\x88\x01\x01\x12_\n" +
	"*tcp_port_forward_rejected_disallowed_count\x18\x8c\x01 \x01(\x03H'R%tcpPortForwardRejectedDisallowedCount\x88\x01\x01\x120\n" +
	"\x11tcp_port_forwards\x18\x8d\x01 \x01(\x03H(R\x0ftcpPortForwards\x88\x01\x01\x12_\n" +
	"*udp_port_forward_rejected_disallowed_count\x18\x8e\x01 \x01(\x03H)R%udpPortForwardRejectedDisallowedCount\x88\x01\x01\x120\n" +
	"\x11udp_port_forwards\x18\x8f\x01 \x01(\x03H*R\x0fudpPortForwards\x88\x01\x01\x12;\n" +
	"\x17total_tcp_port_forwards\x18\x90\x01 \x01(\x03H+R\x14totalTcpPortForwards\x88\x01\x01\x12;\n" +
	"\x17total_udp_port_forwards\x18\x91\x01 \x01(\x03H,R\x14totalUdpPortForwards\x88\x01\x01B\x0e\n" +
	"\f_cpu_percentB\r\n" +
	"\v_heap_allocB\f\n" +
	"\n" +
	"_heap_idleB\r\n" +
	...
	"\x18_total_udp_port_forwardsB?Z=github.com/Psiphon-Labs/psiphon-tunnel-core/psiphon/server/pbb\x06proto3"
...
func file_proto_server_load_proto_init() {
	...
	file_proto_server_load_proto_msgTypes[0].OneofWrappers = []any{}
	file_proto_server_load_proto_msgTypes[1].OneofWrappers = []any{}
	file_proto_server_load_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
