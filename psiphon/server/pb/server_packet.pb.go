...
const file_proto_server_packet_proto_rawDesc = "" +
	"\n" +
	"\x19proto/server_packet.proto\x12\bpsiphond\"\xae\x10\n" +
	"\fServerPacket\x12I\n" +
	...
	"\x14_udp_ipv6_packets_upB?Z=github.com/Psiphon-Labs/psiphon-tunnel-core/psiphon/server/pbb\x06proto3"
...
func file_proto_server_packet_proto_init() {
	...
	file_proto_server_packet_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
