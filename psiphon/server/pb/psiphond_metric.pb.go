...
type PsiphondMetric struct {
	...
	//	*PsiphondMetric_Speedtest
	//	*PsiphondMetric_Tactics
	//	*PsiphondMetric_UniqueUser
	Metric        isPsiphondMetric_Metric `protobuf_oneof:"metric"`
	Timestamp     *timestamppb.Timestamp  `protobuf:"bytes,100,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	HostId        string                  `protobuf:"bytes,101,opt,name=host_id,json=hostId,proto3" json:"host_id,omitempty"`                     //LowCardinality
	HostType      string                  `protobuf:"bytes,102,opt,name=host_type,json=hostType,proto3" json:"host_type,omitempty"`               //Could probably be removed, LowCardinality
	HostBuildRev  string                  `protobuf:"bytes,103,opt,name=host_build_rev,json=hostBuildRev,proto3" json:"host_build_rev,omitempty"` //LowCardinality
	HostProvider  string                  `protobuf:"bytes,104,opt,name=host_provider,json=hostProvider,proto3" json:"host_provider,omitempty"`   //Could be removed, LowCardinality
...
func (x *PsiphondMetric) GetSpeedtest() *SpeedTest {
	if x != nil {
		if x, ok := x.Metric.(*PsiphondMetric_Speedtest); ok {
			return x.Speedtest
		}
	}
	return nil
...
func (x *PsiphondMetric) GetHostProvider() string {
	if x != nil {
...
type PsiphondMetric_Speedtest struct {
	Speedtest *SpeedTest `protobuf:"bytes,15,opt,name=speedtest,proto3,oneof"`
}

type PsiphondMetric_Tactics struct {
	Tactics *Tactics `protobuf:"bytes,16,opt,name=tactics,proto3,oneof"`
}
...
func (*PsiphondMetric_Speedtest) isPsiphondMetric_Metric() {}
...
const file_proto_psiphond_metric_proto_rawDesc = "" +
	"\n" +
	"\x1bproto/psiphond_metric.proto\x12\bpsiphond\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x18proto/domain_bytes.proto\x1a\x19proto/failed_tunnel.proto\x1a\x1aproto/inproxy_broker.proto\x1a\x1cproto/irregular_tunnel.proto\x1a\x19proto/orphan_packet.proto\x1a\x1eproto/remote_server_list.proto\x1a\x1cproto/server_blocklist.proto\x1a\x17proto/server_load.proto\x1a\x18proto/server_panic.proto\x1a\x19proto/server_packet.proto\x1a\x19proto/server_tunnel.proto\x1a\x15proto/speedtest.proto\x1a\x13proto/tactics.proto\x1a\x17proto/unique_user.proto\"\xbb\n" +
	"\n" +
	...
	"\x1cserver_tunnel_asn_dest_bytes\x18\x0e \x01(\v2\".psiphond.ServerTunnelASNDestBytesH\x00R\x18serverTunnelAsnDestBytes\x123\n" +
	"\tspeedtest\x18\x0f \x01(\v2\x13.psiphond.SpeedTestH\x00R\tspeedtest\x12-\n" +
	"\atactics\x18\x10 \x01(\v2\x11.psiphond.TacticsH\x00R\atactics\x127\n" +
	"\vunique_user\x18\x11 \x01(\v2\x14.psiphond.UniqueUserH\x00R\n" +
	"uniqueUser\x128\n" +
	"\ttimestamp\x18d \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\x12\x17\n" +
	"\ahost_id\x18e \x01(\tR\x06hostId\x12\x1b\n" +
	"\thost_type\x18f \x01(\tR\bhostType\x12$\n" +
	"\x0ehost_build_rev\x18g \x01(\tR\fhostBuildRev\x12#\n" +
	"\rhost_provider\x18h \x01(\tR\fhostProviderB\b\n" +
	"\x06metricB?Z=github.com/Psiphon-Labs/psiphon-tunnel-core/psiphon/server/pbb\x06proto3"
...
var file_proto_psiphond_metric_proto_goTypes = []any{
	...
	(*SpeedTest)(nil),                // 15: psiphond.SpeedTest
	(*Tactics)(nil),                  // 16: psiphond.Tactics
...
var file_proto_psiphond_metric_proto_depIdxs = []int32{
	...
	15, // 14: psiphond.PsiphondMetric.speedtest:type_name -> psiphond.SpeedTest
	16, // 15: psiphond.PsiphondMetric.tactics:type_name -> psiphond.Tactics
...
func file_proto_psiphond_metric_proto_init() {
	...
	file_proto_speedtest_proto_init()
