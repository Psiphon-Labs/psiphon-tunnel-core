...
type IrregularTunnel struct {
	...
	DuplicateClientIp      string                 `protobuf:"bytes,2,opt,name=duplicate_client_ip,json=duplicateClientIp,proto3" json:"duplicate_client_ip,omitempty"` //LowCardinality
	DuplicateElapsedTimeMs uint64                 `protobuf:"varint,3,opt,name=duplicate_elapsed_time_ms,json=duplicateElapsedTimeMs,proto3" json:"duplicate_elapsed_time_ms,omitempty"`
	DuplicateSeed          string                 `protobuf:"bytes,4,opt,name=duplicate_seed,json=duplicateSeed,proto3" json:"duplicate_seed,omitempty"`
	DuplicateSeedType      string                 `protobuf:"bytes,5,opt,name=duplicate_seed_type,json=duplicateSeedType,proto3" json:"duplicate_seed_type,omitempty"` //LowCardinality
	ListenerPortNumber     uint32                 `protobuf:"varint,6,opt,name=listener_port_number,json=listenerPortNumber,proto3" json:"listener_port_number,omitempty"`
	ListenerProtocol       string                 `protobuf:"bytes,7,opt,name=listener_protocol,json=listenerProtocol,proto3" json:"listener_protocol,omitempty"` //LowCardinality
	TunnelError            string                 `protobuf:"bytes,8,opt,name=tunnel_error,json=tunnelError,proto3" json:"tunnel_error,omitempty"`
...
const file_proto_irregular_tunnel_proto_rawDesc = "" +
	...
	"\x13duplicate_client_ip\x18\x02 \x01(\tR\x11duplicateClientIp\x129\n" +
	"\x19duplicate_elapsed_time_ms\x18\x03 \x01(\x04R\x16duplicateElapsedTimeMs\x12%\n" +
	"\x0eduplicate_seed\x18\x04 \x01(\tR\rduplicateSeed\x12.\n" +
	"\x13duplicate_seed_type\x18\x05 \x01(\tR\x11duplicateSeedType\x120\n" +
	"\x14listener_port_number\x18\x06 \x01(\rR\x12listenerPortNumber\x12+\n" +
	"\x11listener_protocol\x18\a \x01(\tR\x10listenerProtocol\x12!\n" +
	"\ftunnel_error\x18\b \x01(\tR\vtunnelErrorB?Z=github.com/Psiphon-Labs/psiphon-tunnel-core/psiphon/server/pbb\x06proto3"
