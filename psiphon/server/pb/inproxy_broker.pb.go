...
type InproxyBroker struct {
	...
	FilteredIceCandidates         []string               `protobuf:"bytes,112,rep,name=filtered_ice_candidates,json=filteredIceCandidates,proto3" json:"filtered_ice_candidates,omitempty"` //LowCardinality
	...
	IceCandidateTypes             []string               `protobuf:"bytes,118,rep,name=ice_candidate_types,json=iceCandidateTypes,proto3" json:"ice_candidate_types,omitempty"` //LowCardinality
	...
	NatType                       *string                `protobuf:"bytes,123,opt,name=nat_type,json=natType,proto3,oneof" json:"nat_type,omitempty"`                     //LowCardinality
	NetworkType                   *string                `protobuf:"bytes,124,opt,name=network_type,json=networkType,proto3,oneof" json:"network_type,omitempty"`         //LowCardinality
	NewTacticsTag                 *string                `protobuf:"bytes,125,opt,name=new_tactics_tag,json=newTacticsTag,proto3,oneof" json:"new_tactics_tag,omitempty"` //LowCardinality
	OfferMatchIndex               *int64                 `protobuf:"varint,126,opt,name=offer_match_index,json=offerMatchIndex,proto3,oneof" json:"offer_match_index,omitempty"`
	OfferQueueSize                *int64                 `protobuf:"varint,127,opt,name=offer_queue_size,json=offerQueueSize,proto3,oneof" json:"offer_queue_size,omitempty"`
	PeakDownstreamBytesPerSecond  *int64                 `protobuf:"varint,128,opt,name=peak_downstream_bytes_per_second,json=peakDownstreamBytesPerSecond,proto3,oneof" json:"peak_downstream_bytes_per_second,omitempty"`
	PeakUpstreamBytesPerSecond    *int64                 `protobuf:"varint,129,opt,name=peak_upstream_bytes_per_second,json=peakUpstreamBytesPerSecond,proto3,oneof" json:"peak_upstream_bytes_per_second,omitempty"`
	PortMappingTypes              []string               `protobuf:"bytes,130,rep,name=port_mapping_types,json=portMappingTypes,proto3" json:"port_mapping_types,omitempty"` //LowCardinality
	PreferredNatMatch             *bool                  `protobuf:"varint,131,opt,name=preferred_nat_match,json=preferredNatMatch,proto3,oneof" json:"preferred_nat_match,omitempty"`
	ProtocolVersion               *int32                 `protobuf:"varint,132,opt,name=protocol_version,json=protocolVersion,proto3,oneof" json:"protocol_version,omitempty"`
	ProxyId                       *string                `protobuf:"bytes,133,opt,name=proxy_id,json=proxyId,proto3,oneof" json:"proxy_id,omitempty"`                                         //LowCardinality
	ProxyNatType                  *string                `protobuf:"bytes,134,opt,name=proxy_nat_type,json=proxyNatType,proto3,oneof" json:"proxy_nat_type,omitempty"`                        //LowCardinality
	ProxyPortMappingTypes         []string               `protobuf:"bytes,135,rep,name=proxy_port_mapping_types,json=proxyPortMappingTypes,proto3" json:"proxy_port_mapping_types,omitempty"` //LowCardinality
	ServerId                      *string                `protobuf:"bytes,136,opt,name=server_id,json=serverId,proto3,oneof" json:"server_id,omitempty"`                                      //LowCardinality
	StoredTacticsTag              *string                `protobuf:"bytes,137,opt,name=stored_tactics_tag,json=storedTacticsTag,proto3,oneof" json:"stored_tactics_tag,omitempty"`            //LowCardinality
	TimedOut                      *bool                  `protobuf:"varint,138,opt,name=timed_out,json=timedOut,proto3,oneof" json:"timed_out,omitempty"`
...
const file_proto_inproxy_broker_proto_rawDesc = "" +
	"\n" +
	"\x1aproto/inproxy_broker.proto\x12\bpsiphond\x1a\x14proto/metadata.proto\"\xf5\x18\n" +
	"\rInproxyBroker\x12F\n" +
	...
	"\x05error\x18o \x01(\tH\x10R\x05error\x88\x01\x01\x126\n" +
	"\x17filtered_ice_candidates\x18p \x03(\tR\x15filteredIceCandidates\x125\n" +
	"\x14fronting_provider_id\x18q \x01(\tH\x11R\x12frontingProviderId\x88\x01\x01\x12\x1e\n" +
	"\bhas_IPv6\x18r \x01(\bH\x12R\ahasIPv6\x88\x01\x01\x12@\n" +
	"\x1ahas_common_compartment_ids\x18s \x01(\bH\x13R\x17hasCommonCompartmentIds\x88\x01\x01\x12D\n" +
	"\x1chas_personal_compartment_ids\x18t \x01(\bH\x14R\x19hasPersonalCompartmentIds\x88\x01\x01\x12)\n" +
	"\x0ehas_private_IP\x18u \x01(\bH\x15R\fhasPrivateIP\x88\x01\x01\x12.\n" +
	"\x13ice_candidate_types\x18v \x03(\tR\x11iceCandidateTypes\x12$\n" +
	"\vis_priority\x18w \x01(\bH\x16R\n" +
	"isPriority\x88\x01\x01\x12M\n" +
	"!limit_downstream_bytes_per_second\x18x \x01(\x03H\x17R\x1dlimitDownstreamBytesPerSecond\x88\x01\x01\x12I\n" +
	"\x1flimit_upstream_bytes_per_second\x18y \x01(\x03H\x18R\x1blimitUpstreamBytesPerSecond\x88\x01\x01\x12$\n" +
	"\vmax_clients\x18z \x01(\x03H\x19R\n" +
	"maxClients\x88\x01\x01\x12\x1e\n" +
	"\bnat_type\x18{ \x01(\tH\x1aR\anatType\x88\x01\x01\x12&\n" +
	"\fnetwork_type\x18| \x01(\tH\x1bR\vnetworkType\x88\x01\x01\x12+\n" +
	"\x0fnew_tactics_tag\x18} \x01(\tH\x1cR\rnewTacticsTag\x88\x01\x01\x12/\n" +
	"\x11offer_match_index\x18~ \x01(\x03H\x1dR\x0fofferMatchIndex\x88\x01\x01\x12-\n" +
	"\x10offer_queue_size\x18\x7f \x01(\x03H\x1eR\x0eofferQueueSize\x88\x01\x01\x12L\n" +
	" peak_downstream_bytes_per_second\x18\x80\x01 \x01(\x03H\x1fR\x1cpeakDownstreamBytesPerSecond\x88\x01\x01\x12H\n" +
	"\x1epeak_upstream_bytes_per_second\x18\x81\x01 \x01(\x03H R\x1apeakUpstreamBytesPerSecond\x88\x01\x01\x12-\n" +
	"\x12port_mapping_types\x18\x82\x01 \x03(\tR\x10portMappingTypes\x124\n" +
	"\x13preferred_nat_match\x18\x83\x01 \x01(\bH!R\x11preferredNatMatch\x88\x01\x01\x12/\n" +
	"\x10protocol_version\x18\x84\x01 \x01(\x05H\"R\x0fprotocolVersion\x88\x01\x01\x12\x1f\n" +
	"\bproxy_id\x18\x85\x01 \x01(\tH#R\aproxyId\x88\x01\x01\x12*\n" +
	"\x0eproxy_nat_type\x18\x86\x01 \x01(\tH$R\fproxyNatType\x88\x01\x01\x128\n" +
	"\x18proxy_port_mapping_types\x18\x87\x01 \x03(\tR\x15proxyPortMappingTypes\x12!\n" +
	"\tserver_id\x18\x88\x01 \x01(\tH%R\bserverId\x88\x01\x01\x122\n" +
	"\x12stored_tactics_tag\x18\x89\x01 \x01(\tH&R\x10storedTacticsTag\x88\x01\x01\x12!\n" +
	"\ttimed_out\x18\x8a\x01 \x01(\bH'R\btimedOut\x88\x01\x01B\x12\n" +
